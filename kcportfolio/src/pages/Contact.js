...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard('kavinduc.20@cse.mrt.ac.lk');
  const form = useRef(); // Create a ref for the email form
  const toast = useToast(); // Add the useToast hook
      ...
      >
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            <Stack spacing={{ base: 1, md: 2, lg: 3 }}>
              <Heading
                fontSize={{
                  base: '6lg',
                  md: '10lg',
            ...
            >
              ...
              >
                ...
                <Box as='a' href='https://github.com/kgchinthana'>
                  <IconButton
                    aria-label='github'
                    variant='ghost'
                    size='lg'
                ...
                <Box as='a' href='https://twitter.com/KaviChinthana99'>
                  <IconButton
                    aria-label='twitter'
                    variant='ghost'
                    size='lg'
